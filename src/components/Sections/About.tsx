const About = () => {
  return (
    <div id="about" className="flex flex-col gap-[6px] text-xl font-light">
      {/* 
...
Constantly pushing boundaries to make each day better than yesterday! */}
      <p>
        I&apos;m a Front-End Web Developer with expertise in React.js, Next.js,
        and Tailwind CSS. I am passionate about delivering seamless user
        experiences (UX/UI) and as a former designer and technological
